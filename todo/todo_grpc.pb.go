...
type TodoServiceClient interface {
	...
	RemoveTodo(ctx context.Context, in *RemoveTodoParams, opts ...grpc.CallOption) (*RemoveResponse, error)
...
func (c *todoServiceClient) RemoveTodo(ctx context.Context, in *RemoveTodoParams, opts ...grpc.CallOption) (*RemoveResponse, error) {
	out := new(RemoveResponse)
	err := c.cc.Invoke(ctx, "/todo.todoService/removeTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServiceServer interface {
	...
	RemoveTodo(context.Context, *RemoveTodoParams) (*RemoveResponse, error)
...
func (UnimplementedTodoServiceServer) RemoveTodo(context.Context, *RemoveTodoParams) (*RemoveResponse, error) {
...
func _TodoService_RemoveTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.todoService/removeTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).RemoveTodo(ctx, req.(*RemoveTodoParams))
	}
	return interceptor(ctx, in, info, handler)
}
